...
import org.bumbumapps.privacyfriendlymemory.common.MemoGamePlayerFactory;
...
public class MemoGame {
    ...
    public Uri getImageUri(int position){
        ...
        return Uri.parse("android.resource://com.bumbumapps.memogamepro/" + R.drawable.secuso_not_found);
    }
